...
$(document).ready(function()
{
    ...
    $("#navbar-collapse ul li").attr("class", "active");
    $("#navbar-collapse a[href='/" + firstFolder + "/']").parent().attr("class", "active");
    if(($("#footer").height()+$("#footer").offset().top)< ($(document).height() -10)){
