...
function mcImgSlider(i) {
    ...
    var c = "style"
        ...
        , T = zb() < 9
        , Z = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)
        , K = function (a, b) {
            if (a) {
                a.o = b;
    ...
    var G = new L
        ...
        , a, f, o, s, D, A, m, R, x, M, W, e, E, j = null
        , vb = function () {
    ...
    var Y = function () {
        var a = I(i.sliderId);
        if (a && t(a)[d] && a.offsetHeight) j = new kb(a);
        else u(Y, 500)
    };
    X();
    var Ab = function (c) {
